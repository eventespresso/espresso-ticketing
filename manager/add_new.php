        ...
        <ul>
          <li>
            ...
            <input type="text" name="ticket_name" size="25" />
							<a class="thickbox"  href="#TB_inline?height=400&amp;width=500&amp;inlineId=ticket_name_info" target="_blank"><img src="<?php echo EVENT_ESPRESSO_PLUGINFULLURL ?>images/question-frame.png" width="16" height="16" alt="" /></a>
          </li>
          <li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="autosave-info"><span> <a class="thickbox" href="#TB_inline?height=300&width=400&inlineId=custom_ticket_info">
                        ...
                        <?php _e('Ticket Example','event_espresso'); ?>
                        </a> </span></td>
                    </tr>
                  </tbody>
                </table>
